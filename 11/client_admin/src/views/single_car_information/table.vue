	...
	<el-main class="bg table_wrap">
		<el-form label-position="right" :model="query" class="form p_4" label-width="120">
			<el-row>
					...
					<el-form-item label="管理序号">
									<el-input v-model="query.management_serial_number"></el-input>
								</el-form-item>
				</el-col>
												<el-col :xs="24" :sm="24" :lg="8" class="el_form_search_wrap">
					<el-form-item label="单车类型">
									<el-select v-model="query.single_vehicle_type">
								...
								:value="o.single_vehicle_type">
																		...
																		<el-col :xs="24" :sm="24" :lg="8" class="el_form_search_wrap">
					<el-form-item label="租用标准">
									<el-select v-model="query.rental_standards">
				                            <el-option v-for="o in list_rental_standards" :key="o" :label="o"
                            	:value="o">
                            </el-option>
										</el-select>
								</el-form-item>
					...
					<el-form-item>
						...
						<router-link v-if="user_group == '管理员' || $check_action('/single_car_information/table','add') || $check_action('/single_car_information/view','add')" class="el-button el-button--default el-button--primary search_btn_add" to="./view?">添加
						</router-link>
            			<el-button v-if="user_group == '管理员' || $check_action('/single_car_information/table','del') || $check_action('/single_car_information/view','del')" class="search_btn_del" type="danger" @click="delInfo()">删除</el-button>
					</el-form-item>
				</el-col>
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			<el-table-column fixed type="selection" tooltip-effect="dark" width="55">
				...
				v-if="user_group == '管理员' || $check_field('get','single_vehicle_type')" min-width="200">
					...
					<el-table-column prop="cover_image" @sort-change="$sortChange" label="封面图"
				v-if="user_group == '管理员' || $check_field('get','cover_image')" min-width="200">
				...
				v-if="user_group == '管理员' || $check_field('get','rental_unit_price')" min-width="200">
					...
					<el-table-column prop="number_of_single_vehicles" @sort-change="$sortChange" label="单车数量"
				v-if="user_group == '管理员' || $check_field('get','number_of_single_vehicles')" min-width="200">
					</el-table-column>
			...
			<el-table-column fixed="right" label="操作" min-width="120" v-if="user_group == '管理员' || $check_action('/single_car_information/table','set') || $check_action('/single_car_information/view','set') || $check_action('/single_car_information/view','get') || $check_action('/租用/table','add') || $check_action('/租用/view','add')" >


				<template slot-scope="scope">
					<router-link class="el-button el-button--small is-plain el-button--success" style="margin: 5px !important;"
					v-if="user_group == '管理员' || $check_action('/single_car_information/table','set') || $check_action('/single_car_information/view','set') || $check_action('/single_car_information/view','get')"
						:to="'./view?' + field + '=' + scope.row[field]"
						 size="small">
						<span>详情</span>
					</router-link>
						<router-link v-if="user_group == '管理员' || $check_comment('/single_car_information/table')" class="el-button el-button--small is-plain el-button--primary"
								  :to="'../comment/table?size=10&page=1&source_table=single_car_information&source_field=' + field + '&source_id=' + scope.row[field]" size="small">
					查看评论
					</router-link>
					</template>
			</el-table-column>
	...
	export default {
		...
		data() {
			return {
				...
				url_del: "~/api/single_car_information/del?",
