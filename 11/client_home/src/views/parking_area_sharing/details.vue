<template>
	<div class="diy_details page_parking_area_sharing" id="parking_area_sharing_details">
		<div class='warp'>
			<div class='container'>
				<div class='row'>
					<div class='col'>
						<div class='card_parking_area_sharing'>
							<div_parking_area_sharing :obj="obj"></div_parking_area_sharing>
...
<script>
	import div_parking_area_sharing from "@/components/diy/div_parking_area_sharing.vue";
			...
			return{
				...
				query: {
						"area_name": "",
							"cover": "",
							"site_area": "",
							"number_of_vehicles_accommodated": 0,
							"regional_address": "",
							"details": "",
				...
				form_comment: {
					...
					source_field: "parking_area_sharing_id",
					source_id: 0,
					reply_to_id: 0,
				},
				count_pages: 1, // 页面数
		...
		methods:{
			get_obj_after(json) {
				...
				if (json && json.result && json.result.obj) {
					...
					this.form_comment.source_id = this.obj.parking_area_sharing_id;
				}
			},
			/**
			 * 初始化收藏状态
			...
			get_collect(obj) {
				...
				var query = {
					source_table: "parking_area_sharing",
					source_field: "parking_area_sharing_id",
					source_id: obj["parking_area_sharing_id"],
					user_id
				};
		 ...
		 /****
			...
			change_collect() {
				...
				var query = {
					source_table: "parking_area_sharing",
					source_field: "parking_area_sharing_id",
					source_id: this.obj["parking_area_sharing_id"],
					user_id
				};
				...
				if (this.state_collect) {
					...
					this.state_collect = true;
								query.title = this.obj.area_name
