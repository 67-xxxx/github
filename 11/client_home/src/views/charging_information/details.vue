<template>
	<div class="diy_details page_charging_information" id="charging_information_details">
		<div class='warp'>
			<div class='container'>
				<div class='row'>
					<div class='col'>
						<div class='card_charging_information'>
							<div_charging_information :obj="obj"></div_charging_information>
...
<script>
	import div_charging_information from "@/components/diy/div_charging_information.vue";
			...
			return{
				...
				query: {
						"name_of_electric_pile": "",
							...
							"revenue_voltage": "",
							"revenue_current": "",
							"number_of_electric_piles": 0,
							"charging_unit_price": 0,
							"charging_standard": "",
							"charging_address": "",
				...
				form_comment: {
					...
					source_field: "charging_information_id",
					source_id: 0,
					reply_to_id: 0,
				},
				count_pages: 1, // 页面数
		...
		methods:{
			get_obj_after(json) {
				...
				if (json && json.result && json.result.obj) {
					...
					this.form_comment.source_id = this.obj.charging_information_id;
				}
			},
			/**
			 * 初始化收藏状态
			...
			get_collect(obj) {
				...
				var query = {
					source_table: "charging_information",
					source_field: "charging_information_id",
					source_id: obj["charging_information_id"],
					user_id
				};
		 ...
		 /****
			...
			change_collect() {
				...
				var query = {
					source_table: "charging_information",
					source_field: "charging_information_id",
					source_id: this.obj["charging_information_id"],
					user_id
				};
				...
				if (this.state_collect) {
					...
					this.state_collect = true;
								query.title = this.obj.name_of_electric_pile
														query.img = this.obj.electric_pile_cover
