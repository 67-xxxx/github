<template>
	<div class="diy_details page_single_car_information" id="single_car_information_details">
		<div class='warp'>
			<div class='container'>
				<div class='row'>
					<div class='col'>
						<div class='card_single_car_information'>
							<div_single_car_information :obj="obj"></div_single_car_information>
...
<script>
	import div_single_car_information from "@/components/diy/div_single_car_information.vue";
	...
	export default {
		...
		data(){
			return{
				...
				form_comment: {
					...
					source_field: "single_car_information_id",
					source_id: 0,
					reply_to_id: 0,
				},
				count_pages: 1, // 页面数
		...
		methods:{
			...
			add_hits(obj) {
				obj["hits"] = obj["hits"] + 1;
				var hits = obj["hits"];
				this.$post('~/api/single_car_information/set?single_car_information_id=' + obj["single_car_information_id"], {
					hits
				}, (res) => {
					if(res.result){
						...
						var body = {
							source_table: "single_car_information",
							source_field: "single_car_information_id",
							source_id: this.obj.single_car_information_id,
			...
			get_obj_after(json) {
				...
				if (json && json.result && json.result.obj) {
					...
					this.form_comment.source_id = this.obj.single_car_information_id;
				}
			},
			/**
			 * 初始化收藏状态
			...
			get_collect(obj) {
				...
				var query = {
					source_table: "single_car_information",
					source_field: "single_car_information_id",
					source_id: obj["single_car_information_id"],
					user_id
				};
			...
			change_collect() {
				...
				if (this.state_collect) {
					...
					this.state_collect = true;
													query.title = this.obj.name_of_single_vehicle
