<template>
	<div class="diy_details_box diy_div_charging_information">
		<div class="warp">
			<div class="container">
				...
				<div class="row">
					...
					<div class="details_btn_wrap">
								<button class="btn btn-primary details_btn" v-if="$check_action('/charging_information/details','set')" @click="change_collect()" >收藏</button>
							</div>
						<!-- 富文本 -->
...
<script>
	...
	export default {
      ...
      check_collect() {
        ...
        var charging_information_id = this.obj.charging_information_id;
        this.$get('~/api/collect/count?', {
          user_id,
          source_table: "charging_information",
          source_field: "charging_information_id",
          source_id: charging_information_id
        }, (res) => {
