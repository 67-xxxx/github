<template>
	<div class="diy_details_box diy_div_single_car_information">
		<div class="warp">
			<div class="container">
				...
				<div class="row">
					...
					<div class="details_btn_wrap">
											<button class="btn btn-primary details_btn" v-if="$check_action('/lease_information/edit','add')" @click="to_form('/lease_information/edit')" > 租用 </button>
											<button class="btn btn-primary details_btn" v-if="$check_action('/single_car_information/details','set')" @click="change_collect()" >收藏</button>
							</div>
						<!-- 富文本 -->
...
<script>
	...
	export default {
      ...
      check_collect() {
        ...
        var single_car_information_id = this.obj.single_car_information_id;
        this.$get('~/api/collect/count?', {
          user_id,
          source_table: "single_car_information",
          source_field: "single_car_information_id",
          source_id: single_car_information_id
        }, (res) => {
