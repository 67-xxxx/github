<template>
	<div class="diy_details_box diy_div_parking_area_sharing">
		<div class="warp">
			<div class="container">
				...
				<div class="row">
					...
					<div class="details_btn_wrap">
								<button class="btn btn-primary details_btn" v-if="$check_action('/parking_area_sharing/details','set')" @click="change_collect()" >收藏</button>
							</div>
						<!-- 富文本 -->
...
<script>
	...
	export default {
      ...
      check_collect() {
        ...
        var parking_area_sharing_id = this.obj.parking_area_sharing_id;
        this.$get('~/api/collect/count?', {
          user_id,
          source_table: "parking_area_sharing",
          source_field: "parking_area_sharing_id",
          source_id: parking_area_sharing_id
        }, (res) => {
