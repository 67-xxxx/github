<template>
	<div class="diy_home diy_list diy_return_information" id="diy_return_information_list">
		<!-- 列表 -->
		<div class="diy_view_list list list-x" v-if="show">
			<router-link class="diy_card goods diy_list_box_wrap" v-for="(o, i) in list" :key="i"
				:to="'/return_information/details?return_information_id=' + o['return_information_id']">
				<!-- 图片 -->
				<div class="diy_list_img_box" v-if="imgList.length" >
					<div class="diy_row" v-for="(item,index) in imgList" :key="item+index" v-show="$check_field('get',item.name,'/return_information/details') && +item.is_img_list">
				...
				<div class="diy_list_item_box">
					<div class="diy_list_item_content" v-for="(item,index) in showItemList" :key="item+index">
						<div class="diy_row" :class="{[item.name]:true}" v-if="$check_field('get',item.name,'/return_information/details') && +item.is_img_list">
							<div class="diy_title">
								<span>{{item.title}}:</span>
							</div>
		...
		<div class="diy_view_table" v-else>
			<table class="diy_table">
				<tr class="diy_row">
						<th class="diy_title" v-if="$check_field('get','lease_number')">
						租用号
					</th>
						...
						车主用户
							...
							<th class="diy_title" v-if="$check_field('get','car_rental_users')">
						租车用户
					</th>
							<th class="diy_title" v-if="$check_field('get','number_of_leases')">
						租用数量
					</th>
							<th class="diy_title" v-if="$check_field('get','lease_date')">
						租用日期
					</th>
							<th class="diy_title" v-if="$check_field('get','return_date')">
						归还日期
					</th>
							<th class="diy_title" v-if="$check_field('get','lending_time')">
						出借时间
					</th>
				...
				<tr class="diy_row" v-for="(o,i) in list" :key="o+i">
						<td class="diy_field diy_text" v-if="$check_field('get','lease_number')">
						<span>
							{{ o["lease_number"] }}
						</span>
					</td>
						...
						<span>
							...
							<td class="diy_field diy_uid" v-if="$check_field('get','car_rental_users')">
						<span>
							{{ get_user_name('car_rental_users',o['car_rental_users']) }}
						</span>
					</td>
							<td class="diy_field diy_number" v-if="$check_field('get','number_of_leases')">
						<span>
							{{ o["number_of_leases"] }}
						</span>
					</td>
						...
						<span>
							...
							<td class="diy_field diy_number" v-if="$check_field('get','lending_time')">
						<span>
							{{ o["lending_time"] }}
						</span>
					</td>
							<td class="diy_field diy_text" v-if="$check_field('get','payment_amount')">
						<span>
							{{ o["payment_amount"] }}
						</span>
					</td>
			...
			get_user_name(name,id){
				var obj = null;
					...
					obj = this.list_user_owner_user.getObj({"user_id":id});
						...
						if (name == 'car_rental_users'){
					obj = this.list_user_car_rental_users.getObj({"user_id":id});
				}
										var ret = "";
				if(obj){
